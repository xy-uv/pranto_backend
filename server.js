    ...
    const defaultProducts = [
      {
        ...
        description:
          "High-speed dual-band wireless router with 4 Gigabit LAN ports and advanced security features.",
        specifications: {
      ...
      },
      {
        ...
        description:
          "Fast and reliable 500GB SATA SSD for improved system performance and faster boot times.",
        specifications: {
          Capacity: "500GB",
  ...
  try {
    ...
    switch (type) {
      ...
      case "customerId":
        ...
        filteredSales = sales.filter(
          (sale) => sale.customerId === value || sale.userId === value
        );
        break;
      ...
      default:
        return res.status(400).json({
          success: false,
          message:
            "Invalid search type. Use: productId, customerId, or mobileNumber",
        });
    }
